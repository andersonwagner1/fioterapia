...
import {  UsuariosConfigRoutingModule } from './usuarios-config-routing.module';
...
@NgModule({
    ...
    declarations: [UsuariosConfigComponent]
})
export class UsuariosConfigModule { }
